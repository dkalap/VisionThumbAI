...
export default function Navbar() {
    ...
    return (
        <>
            ...
            >
                <Link to='/'>
                    <img src="/logo2.svg.jpg" alt="logo" className="h-8.5 w-auto"/>
                </Link>

                <div className="hidden md:flex items-center gap-8 transition duration-500">

                    <Link to='/' className="hover:text-pink-500 transition">Home
                    </Link>
                    <Link to='/generate' className="hover:text-pink-500 transition">Generate
                    </Link>
                    <Link to='/my-generation' className="hover:text-pink-500 transition">My Generations
                    </Link>
                    <Link to='#' className="hover:text-pink-500 transition">Contact
                    </Link>
