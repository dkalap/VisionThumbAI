...
import {SparkleIcon,SquareIcon,ImageIcon,PenToolIcon,CpuIcon,ChevronDownIcon } from "lucide-react";
  ...
  return (
    <div className="relative space-y-3 dark">
        ...
        className="flex w-full items-center justify-between rounded-md border px-4 py-3 text-left transition bg-white/8 border-white/10 text-zinc-200 hover:bg-white/12">
            ...
            <ChevronDownIcon className={['h-5 w-5 text-zinc-400 transition-transform',
